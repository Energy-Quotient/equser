...
def get_data_dir() -> Path:
    ...
    2. /var/lib/eq-coherence/data (gateway deployment, if exists)
    ...
    # Gateway deployment path (where EQ Coherence writes CPOW/PMon data)
    system_data = Path('/var/lib/eq-coherence/data')
